...
namespace Locations.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CityId,Name")] District district)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CityId,Name")] District district)
        {
            if (id != district.Id)
            {
                return NotFound();
