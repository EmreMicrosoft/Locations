...
namespace Locations.Controllers
{
    public class StatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CountryId,Name")] State state)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(short id, [Bind("Id,CountryId,Name")] State state)
        {
            if (id != state.Id)
            {
                return NotFound();
